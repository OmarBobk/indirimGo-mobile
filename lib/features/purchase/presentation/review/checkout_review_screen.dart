...
class _CheckoutReviewScreenState extends ConsumerState<CheckoutReviewScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final canConfirm =
        quote.wallet.canAfford &&
        review.phase != CheckoutReviewPhase.submitting &&
        review.phase != CheckoutReviewPhase.refreshingQuote &&
        !review.submittingLocked &&
        review.phase != CheckoutReviewPhase.unavailable;
          ...
          children: [
            ...
            Text(
              quote.item.amountMode == ProductAmountMode.fixed
                  ...
                  : l10n.requestedAmountValue(quote.item.requestedAmount ?? 0),
            ),
            ...
            Text(
              ...
              l10n.quoteExpiresAt(quote.expiresAt.toLocal().toIso8601String()),
